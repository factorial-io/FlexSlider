...
(function ($) {
    ...
    methods = {
      ...
      controlNav: {
        ...
        setupPaging: function() {
          ...
          slider.controlNavScaffold = $('<ol class="'+ namespace + 'controlNav ' + namespace + type + '"></ol>');
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i += 1) {
              ...
              // TODO: Review data-thumbcaption case.
        ...
        set: function() {
          ...
          slider.controlNav = $('.' + namespace + 'controlNav li ' + selector, (slider.controlsContainer) ? slider.controlsContainer : slider);
        },
        active: function() {
  ...
  $.flexslider.defaults = {
    namespace: 'FlexSlider-',             //{NEW} String: Prefix string attached to the class of every element generated by the plugin
    selector: '.FlexSlider-slides > .FlexSlider-slide',       //{NEW} Selector: Must match a simple pattern. '{container} > {slide}' -- Ignore pattern at your own peril
  ...
  $.fn.flexslider = function(options) {
    ...
    if (typeof options === 'object') {
      return this.each(function() {
        var $this = $(this);
        var selector = (options.selector) ? options.selector : '.FlexSlider-slides > .FlexSlider-slide';
  ...
  // Automatically instantiates FlexSlider on elements with the appropriate
  // JavaScript class.
